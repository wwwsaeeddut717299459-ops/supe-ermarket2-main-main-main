...
import 'package:almajed_pro/features/audit/data/services/audit_service.dart';
import 'package:almajed_pro/features/invoices/data/services/invoice_print_service.dart';
import 'package:almajed_pro/features/auth/data/auth_providers.dart' as auth;
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          ...
          children: [
            ...
            const Text(
              'F1 بحث المنتج  ·  F2 آجل  ·  F3 العميل  ·  F4 فاتورة جديدة  ·  F5 إتمام البيع  ·  F6 الباركود  ·  F12 المساعدة',
              style: TextStyle(
                fontSize: 13,
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: const [
                ...
                DropdownMenuItem(value: 'credit', child: Text('آجل (F2)')),
              ],
              onChanged: (value) {
            ...
            SizedBox(
              ...
              child: FilledButton.icon(
                ...
                label: Text(_saving ? 'جاري حفظ الفاتورة...' : 'إتمام البيع (F5)'),
              ),
            ),
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                icon: const Icon(Icons.clear),
                label: const Text('إلغاء الفاتورة (F4)'),
              ),
            ),
          ],
        ),
              ...
              child: Row(
                children: [
                  ...
                  FilledButton.icon(
                    ...
                    icon: const Icon(Icons.payments_outlined),
                    label: const Text('الدفع وإتمام البيع (F5)'),
                  ),
                ],
              ),
            ),
                ...
                Padding(
                  ...
                  child: Center(
                    child: Chip(
                      ...
                      label: Text(_currency.name(_currencyCode)),
                    ),
                  ),
                ),
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                const Expanded(
                                  child: Text('almajedPRO • مبيعات سريعة ومنظمة', style: TextStyle(fontWeight: FontWeight.bold)),
                                ),
