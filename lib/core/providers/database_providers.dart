...
import 'package:almajed_pro/core/database/database_provider.dart' as shared_db;
...
import 'package:almajed_pro/core/database/daos/customers_dao.dart';
import 'package:almajed_pro/core/database/daos/customer_transactions_dao.dart';
import 'package:almajed_pro/core/database/daos/stock_movements_dao.dart';

import 'package:almajed_pro/features/sales/data/services/sale_service.dart';
...
import 'package:almajed_pro/core/database/daos/roles_dao.dart';
import 'package:almajed_pro/core/database/daos/permissions_dao.dart';
import 'package:almajed_pro/core/database/daos/role_permissions_dao.dart';
import 'package:almajed_pro/core/database/daos/users_dao.dart';
import 'package:almajed_pro/core/database/daos/sales_dao.dart';
import 'package:almajed_pro/core/database/daos/sale_items_dao.dart';
import 'package:almajed_pro/core/database/daos/invoice_settings_dao.dart';
import 'package:almajed_pro/core/database/daos/suppliers_dao.dart';
import 'package:almajed_pro/core/database/daos/supplier_transactions_dao.dart';
import 'package:almajed_pro/core/database/daos/purchases_dao.dart';
import 'package:almajed_pro/core/database/daos/purchase_items_dao.dart';
import 'package:almajed_pro/core/database/daos/expense_categories_dao.dart';
import 'package:almajed_pro/core/database/daos/expenses_dao.dart';
import 'package:almajed_pro/core/database/daos/returns_dao.dart';
import 'package:almajed_pro/core/database/daos/return_items_dao.dart';
import 'package:almajed_pro/features/purchases/data/services/purchase_service.dart';
import 'package:almajed_pro/core/services/finance_service.dart';
import 'package:almajed_pro/features/suppliers/data/services/supplier_service.dart';
import 'package:almajed_pro/features/backup/data/services/backup_service.dart';
import 'package:almajed_pro/features/validation/data/services/automated_validation_service.dart';
import 'package:almajed_pro/features/returns/data/services/returns_service.dart';
import 'package:almajed_pro/features/accounting/data/services/accounting_service.dart';
import 'package:almajed_pro/features/reports/data/services/detailed_reports_service.dart';
import 'package:almajed_pro/features/dashboard/data/services/dashboard_service.dart';
import 'package:almajed_pro/features/reports/data/services/business_analytics_service.dart';
import 'package:almajed_pro/features/employees/data/services/employee_service.dart';

import 'package:almajed_pro/features/settings/data/repositories/invoice_settings_repository.dart';
...
import 'package:almajed_pro/features/sales/data/repositories/sales_repository.dart';
import 'package:almajed_pro/features/sales/data/repositories/sale_items_repository.dart';
