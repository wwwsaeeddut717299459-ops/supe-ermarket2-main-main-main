...
class AppDatabase extends _$AppDatabase {
  ...
  MigrationStrategy get migration {
    return MigrationStrategy(
      ...
      onCreate: (Migrator m) async {
        ...
        await _createPerformanceIndexesV2();
      ...
      beforeOpen: (details) async {
        ...
        // تحسينات ذاكرة SQLite للملفات الكبيرة مع الحفاظ على WAL.
      ...
      onUpgrade: (Migrator m, int from, int to) async {
        ...
        // محفوظ للتوافق مع قواعد البيانات السابقة.
        // ========================================================
        if (from < 12) {
          // محفوظ عمدًا للتوافق مع قواعد البيانات القديمة.
        }

        // ========================================================
        // الإصدار 12 -> الإصدار 13
        // فهارس أداء إضافية للبيانات الكبيرة جدًا.
        // ========================================================
        if (from < 13) {
          await _createPerformanceIndexesV2();
          await customStatement('PRAGMA optimize');
  ...
  Future<void> _createPerformanceIndexesV2() async {
    const indexes = [
      ...
      'CREATE INDEX IF NOT EXISTS idx_products_stock_minimum ON products(stock_quantity, minimum_stock)',
      ...
      'CREATE INDEX IF NOT EXISTS idx_customer_transactions_customer_date ON customer_transactions(customer_id, created_at)',
      'CREATE INDEX IF NOT EXISTS idx_supplier_transactions_supplier_date ON supplier_transactions(supplier_id, date)',
      'CREATE INDEX IF NOT EXISTS idx_journal_entries_source_date ON journal_entries(source_type, source_id, entry_date)',
    ];
